...
import com.example.caregiverphase2.model.repository.AddReviewRepository
...
class AddReviewViewModel @Inject constructor(private val repository: AddReviewRepository) : ViewModel() {
    ...
    val response: MutableLiveData<Outcome<AddReviewResponse?>?> = _response

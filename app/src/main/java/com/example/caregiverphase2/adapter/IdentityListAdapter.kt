...
class IdentityListAdapter (private val itemList: List<Identification>,
    ...
    class ViewHolder(private val itemBinding: DocumentListItemLayoutBinding) :
        ...
        fun bind(data: Identification, context: Context, deleteDocClickListener: DeleteDocClickListener) {
            itemBinding.apply {
                Glide.with(context)

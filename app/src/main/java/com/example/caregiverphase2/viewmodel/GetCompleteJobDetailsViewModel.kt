...
import com.example.caregiverphase2.model.repository.GetCompleteJobDetailsRepository
...
@HiltViewModel
class GetCompleteJobDetailsViewModel @Inject constructor(private val repository: GetCompleteJobDetailsRepository) : ViewModel() {
    ...
    fun getCompleteJobDetails(
        ...
        repository.getCompleteJobDetails(
            token, id
        ).onStart {
